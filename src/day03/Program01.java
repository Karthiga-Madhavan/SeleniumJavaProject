...
public class Program01 {
	...
	public static void main(String[] args) {
		...
		action.dragAndDrop(src1, target1).build().perform();		// can directly use only the perform to complete the action but using it with
																	// build to validate Xpath before perform
